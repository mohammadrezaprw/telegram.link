...
// The code:
Client.prototype.getDataCenters = function (callback, hardcoded) {
    hardcoded = typeof hardcoded !== 'undefined' ? hardcoded : true;
    var primaryDCs = staticInfo.telegram.prod.primaryDataCenters;
    if (callback) {
            ...
            api.service.help.getConfig({
                ...
                callback: function (ex, config) {
                    if (ex) {
                        ...
                        var dcList = hardcoded ? primaryDCs : config.dc_options.list;
